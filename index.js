...
console.log(
  ...
  calculateExpression(`3 + 5 * 2`));// Виведе 13
  console.log('calculateExpression(353)',
    calculateExpression(353)); 
...
function isNumberFinite(num) {
  if(isFinite(num)) return `The number is  finite`;
